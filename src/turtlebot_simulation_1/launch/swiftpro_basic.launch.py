...
def generate_launch_description():
    ...
    robot_namespace_group = GroupAction([
        ...
        Node(
            ...
            arguments=['0.0', '0.0', '0.0', str(math.pi/2), '0.0', str(math.pi), 'world_enu', 'base_link']
        ),
        ...
        Node(
            ...
            executable='static_transform_publisher',
            name='ee_broadcaster',
            arguments=['0.0', '0.0', '0.0722', '0.0', '0.0', str(math.pi), PathJoinSubstitution([LaunchConfiguration('robot_name'), 'link8B']), 'end_effector']
        ),
